 ...
 * @author John PV
 */
public class VtnDirAlu extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        setTitle("Direcciones de alumno");
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(VtnDirAlu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
