 ...
 * @author John PV
 */
public class VtnAluProf extends javax.swing.JFrame
{
    ...
    private void initComponents()
    {
        ...
        jLabel2.setText("Ingrese clave del profesor:");
    ...
    {//GEN-HEADEREND:event_btnBuscarActionPerformed
        try
        {
            ...
            String s = Prb.conn.alumProf(a, b);
            if (s.equals(""))
            {
                s = "No existe alumno o profesor";
            }
            textA.setText(s);
        } catch (Exception e)
        {
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(VtnAluProf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
