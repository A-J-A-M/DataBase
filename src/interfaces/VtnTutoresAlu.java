 ...
 * @author John PV
 */
public class VtnTutoresAlu extends javax.swing.JFrame
{

    /**
     * Creates new form VtnCalifAlum
     */
    public VtnTutoresAlu()
    {
        initComponents();
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("Ingrese clave del tutor:");
    ...
    {//GEN-HEADEREND:event_btnBuscarActionPerformed
        try
        {
            ...
            String s = Prb.conn.procedimiento(a);
            if (s.equals(""))
            {
                s = "No existe tutor";
            }
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(VtnTutoresAlu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
